      ...
      <div class="field-box">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <template v-if="Array.isArray(activeData.__config__.regList)">
            ...
            <div style="margin-left: 20px; padding-bottom: 55px;">
...
<script lang="jsx">
  import { isArray } from '@/components/form-generator/utils/index';
  import TreeNodeDialog from './TreeNodeDialog';
  import { isNumberStr } from '@/components/form-generator/utils/index';
  ...
  import { saveFormConf } from '@/components/form-generator/utils/db';
